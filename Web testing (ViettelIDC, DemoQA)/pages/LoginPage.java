...
public class LoginPage {
    ...
    public HomePage login(String username, String password) {
        ...
        // Click login button
        WebElement loginButton = mWebDriver.findElement(By.xpath("//input[@type='submit']"));
        loginButton.click();
...
//        mWebDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@id='user-dropdown']//img")));
        ...
        String menuLoginXPath = "//button[normalize-space()='Open Menu']";
        WebElement menuLoginEle = mWebDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(menuLoginXPath))));
        Assert.assertTrue(Objects.nonNull(menuLoginEle), "Verify that accessing the website");
