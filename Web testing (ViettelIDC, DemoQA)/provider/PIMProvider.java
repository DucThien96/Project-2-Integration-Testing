...
public class PIMProvider {
    @DataProvider(name = "AddEmployee_002_AddNew")
    public Object[][] AddEmployee_002_AddNew(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lession14/data/addEmployee.json";
