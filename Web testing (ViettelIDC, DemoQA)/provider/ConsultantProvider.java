...
public class ConsultantProvider {
    @DataProvider(name = "Consultant_002_Valid")
    public Object[][] Consultant_002_Valid(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lession16/data/consultantData.json";
