...
public class AgencyProvider {
    @DataProvider(name = "Agency_002_Valid")
    public Object[][] Agency_002_Valid(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lession12/data/AgencyData.json";
